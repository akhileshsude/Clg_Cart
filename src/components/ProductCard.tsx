  ...
  return (
    <div className="card group cursor-pointer hover:shadow-2xl hover:shadow-primary-500/30 transition-all duration-500 h-full flex flex-col hover:border-primary-500/50 hover:scale-105 hover:-translate-y-2">
      ...
      <div className="p-4 flex flex-col flex-1">
        <p className="text-xs text-primary-400 uppercase tracking-wide font-semibold mb-1 animate-fade-in-up">
          {category}
        </p>
        <h3 className="font-semibold text-neutral-100 mb-2 line-clamp-2 group-hover:text-primary-300 transition-colors duration-300">
          {name}
        </h3>

        <div className="mt-auto pt-3 border-t border-neutral-700">
          <div className="flex items-center justify-between mb-3">
            <span className="text-lg font-bold text-primary-400 group-hover:text-primary-300 transition-colors duration-300">
              ₹{price}
            </span>
          </div>
          <button
