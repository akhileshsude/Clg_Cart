    ...
    <main className="min-h-[calc(100vh-80px)] bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900">
      <div className="container-main py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary-300 to-primary-500 bg-clip-text text-transparent">
            Shopping Cart
          </h1>
        </div>
        ...
        {items.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-neutral-400 mb-8 max-w-sm">
              Start building your college wardrobe! Browse our collection of
              ...
              <div className="card">
                <div className="divide-y divide-neutral-700">
                  {items.map((item) => (
                    <div
                      key={item.id}
                      className="p-4 md:p-6 flex gap-4 md:gap-6"
                    >
                      {/* Product Image */}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-3 gap-2">
                          ...
                          <p className="text-lg font-bold text-primary-400 flex-shrink-0">
                            ₹{item.price}
                          </p>
                        </div>
